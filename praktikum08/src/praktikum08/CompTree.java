...
public class CompTree implements Iterable{
		 ...
		 */
		public void add(Comparable neu) {
			if(wurzel == null) {
		...
		*/
		void entfernen(Comparable s) {
		    if(wurzel != null)
		    	wurzel = wurzel.entfernen(s); 
		}
		
		@Override
		public CompIterator iterator(){
			CompIterator iterator = new CompIterator(this.wurzel);
			return iterator;
		}
		...
		private class Node{
			 ...
			 * @param neu, neue Comparable nutzlast einfügen
			 */
			private void add(Comparable neu) {
			 ...
			 */
			private boolean contains(Comparable s) {
			 ...
			 * @return
			 */
			Node entfernen(Comparable s) {
			    
			    int vergleich = s.compareTo(nutzlast);
			    if(vergleich == 0) {
		...
		private class CompIterator implements java.util.Iterator{
			Node currentNode;
			
			CompIterator(Node wurzel){
